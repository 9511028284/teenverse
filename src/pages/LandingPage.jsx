...
const LandingPage = ({ setView, darkMode, toggleTheme, onLegalClick }) => {
  ...
  const [activeTab, setActiveTab] = useState('creators'); // 'creators' or 'clients'
    ...
    <div className={`relative min-h-screen selection:bg-[#ccff00] selection:text-black ${darkMode ? 'bg-[#050505] text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <section id="explore" className="py-32 px-6 max-w-7xl mx-auto">
         ...
         <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[300px]">
            {/* 1. ESCROW CARD */}
            <TiltCard className="md:col-span-2 row-span-2 bg-[#0F0F0F] rounded-[2.5rem] p-10 border border-white/5 relative overflow-hidden group">
            ...
            {/* 2. STAT CARD */}
            <TiltCard className="md:col-span-1 bg-white text-black rounded-[2.5rem] p-8 flex flex-col justify-between group hover-target">
            ...
            {/* 3. VISUAL CARD */}
            <TiltCard className="md:col-span-1 row-span-2 rounded-[2.5rem] overflow-hidden relative group">
            ...
            {/* 4. TECH STACK */}
            <TiltCard className="md:col-span-1 bg-[#1a1a1a] border border-white/10 rounded-[2.5rem] p-8 relative overflow-hidden group">
            ...
            {/* 5. SAFETY */}
            <TiltCard className="md:col-span-2 bg-gradient-to-br from-[#111] to-[#000] border border-white/10 rounded-[2.5rem] p-8 flex items-center justify-between group">
      ...
      <footer className="bg-black text-white pt-20 pb-10 border-t border-white/10 relative z-10">
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="space-y-6">
               <h3 className="text-2xl font-black tracking-tighter">TeenVerse<span className="text-[#ccff00]">.</span></h3>
  ...
  links: ['Explore Gigs', 'Post Job', 'Login', 'Parent Portal'] 
         ...
         <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600 font-mono">
            <div>© 2025 TeenVerse Inc. System Operational.</div>
