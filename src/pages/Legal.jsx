...
const Legal = ({ onBack, page = "terms" }) => {
  ...
  const documents = {
    ...
    privacy: {
      ...
      content: (
        <div className="space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed">
          <p>TeenVerseHub respects your privacy. This policy outlines how we handle your data in compliance with the Digital Personal Data Protection Act (DPDP).</p>
    ...
    fees: {
      ...
      content: (
        <div className="space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <p>
            TeenVerseHub charges a flat <strong>4% Platform Fee</strong> on all successful transactions. 
            This fee covers payment gateway charges, server costs, and safety monitoring.
          </p>
          <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg border-l-4 border-indigo-500 my-4">
            ...
            <p className="font-mono text-sm">TeenVerse Fee: -₹40</p>
            <p className="font-mono text-sm font-bold">Freelancer Receives: ₹960</p>
          </div>

          <h4 className="text-lg font-bold text-gray-900 dark:text-white mt-6">2. Escrow Policy</h4>
          <p>
            Funds are held in a secure Escrow account until the Freelancer marks the job as 'Submitted' and the Client approves it. 
          ...
          <p>
            Freelancers are solely responsible for reporting their income and paying applicable taxes. TeenVerseHub does not deduct TDS unless required by future regulation updates.
          </p>
        </div>
      )
    },
      ...
      content: (
        <div className="space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <ol className="list-decimal ml-5 space-y-2">
            ...
            <li>Funds in Escrow are frozen immediately.</li>
      ...
      content: (
        <div className="space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <p>
            ...
            TeenVerseHub is not liable for interactions that occur off-platform (e.g., if your teen shares their personal WhatsApp).
          </p>

          <h4 className="text-lg font-bold text-gray-900 dark:text-white mt-6">3. Right to Revoke</h4>
          <p>
            You retain the absolute right to revoke your consent at any time. Upon revocation, we will freeze the teen's account 
      ...
      content: (
        <div className="space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <p>
            ...
            <br/>
            - <strong>After Payment:</strong> Upon successful release of funds from Escrow, full ownership and IP rights transfer exclusively to the Client.
          </p>
