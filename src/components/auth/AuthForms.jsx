...
// Assuming these exist in your project structure, or you can copy them from your existing file
            ...
            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                ...
                <div className="space-y-4 max-h-[50vh] overflow-y-auto pr-2 custom-scrollbar">
                    {formData.role === 'freelancer' ? (
                        <div className="space-y-4">
                            <div className="bg-white/5 p-5 rounded-2xl border border-white/10 space-y-3">
                                <div className="flex justify-between items-center">
                                    ...
                                    {state.age && (
                                        <span className="text-[10px] font-black px-2 py-0.5 rounded bg-indigo-500/20 text-indigo-400 border border-indigo-500/30">
                                            AGE: {state.age}
                                        </span>
                                    )}
                                </div>
                                <input 
                                    ...
                                    className="w-full bg-black/40 border border-gray-600 rounded-lg p-3 text-white focus:border-indigo-500 outline-none font-mono transition-colors"
                                />
                                ...
                                {state.isMinor && (
                                    ...
                                    >
                                        <div className="mt-2 bg-orange-500/10 border border-orange-500/30 p-4 rounded-xl">
                                            <div className="flex gap-2 items-center mb-2 text-orange-400">
                                                <ShieldAlert size={16}/>
                                                <span className="text-xs font-bold uppercase tracking-tighter">Guardian Authorization Required</span>
                                            </div>
                                            <input 
                                                type="email" 
                                                ...
                                                className="w-full bg-black/50 border border-gray-700 rounded-lg p-3 text-white focus:border-orange-500 outline-none placeholder-gray-600 transition-all"
                                            />
                                            <p className="text-[9px] text-orange-500/70 mt-2 leading-tight uppercase font-medium">
                                                As you are under 18, a verification link will be sent to your guardian.
                                            </p>
                                        </div>
                                    </motion.div>
                                )}
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {['Male', 'Female', 'Other'].map((g) => (
                                    <button
                                        ...
                                        className={`py-3 rounded-xl border text-xs font-bold transition-all ${formData.gender === g ? 'bg-indigo-500 border-indigo-400 text-white' : 'bg-white/5 border-white/10 text-gray-500'}`}
                                    >
                                        {g}
                                    </button>
                                ))}
                        ...
                        <div className="space-y-4">
                            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1">Company Details</label>
                            <input 
