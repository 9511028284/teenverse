  ...
  const freelancerPlans = [
    {
      ...
      features: [
        ...
        { text: '4 AI quizzes / month', included: true },
        { text: '3 AI assistant chats / day', included: true },
        { text: '5 AI work checks / month', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: '30 AI quizzes / month', included: true },
        { text: '20 AI assistant chats / day', included: true },
        { text: '100 AI work checks / month', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: '20 resumes / month', included: true },
        { text: '200 AI quizzes / month', included: true },
        { text: '100 AI assistant chats / day', included: true },
        { text: '300 AI work checks / month', included: true },
