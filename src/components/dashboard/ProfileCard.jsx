      ...
      >
        ...
        <div className="relative z-20 h-full flex flex-col items-center p-8 text-center justify-between">
           ...
           <div className="space-y-3">
               <h2 className="text-4xl font-black text-white tracking-tighter drop-shadow-lg font-sans flex items-center justify-center gap-2">
                 {user.name || "Anonymous"}
                 {isVerified && <CheckCircle size={22} className="text-sky-300 fill-sky-300/20" />}
               </h2>
