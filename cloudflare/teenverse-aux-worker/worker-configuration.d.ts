/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fb2023717477c2171abc97d66057663d)
// Runtime types generated with workerd@1.20260616.1 2026-06-30 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMIT_KV: KVNamespace;
	TEENVERSE_FILES: R2Bucket;
	AUX_DB: D1Database;
	SUPABASE_URL: "https://bjxmxihjcbgieaohqipw.supabase.co";
	SUPABASE_JWT_ISSUER: "https://bjxmxihjcbgieaohqipw.supabase.co/auth/v1";
	ALLOWED_ORIGINS: "https://app.teenversehub.in,https://intern.teenversehub.in,https://business.teenversehub.in,http://localhost:5173,http://localhost:5174";
	VERCEL_PRODUCTION_URL: "https://app.teenversehub.in";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_JWT_ISSUER" | "ALLOWED_ORIGINS" | "VERCEL_PRODUCTION_URL">> {}
}
